...
async def MISSION_3():
    ...
    await GYRO_INCH(15,300)
    await LEFT_GYRO(88,100)
    await ARM_MOTOR(ARM_RIGHT,222,150)
    sleep(0.5)
    await GYRO_INCH_BK(1,-200)
    await RIGHT_GYRO(120,300)
    await GYRO_INCH_BK(5.7,200)
    await GYRO_INCH(2,100)
    await ARM_MOTOR(ARM_RIGHT,-220,300)
    sleep(0.5)
    await GYRO_INCH(5.5,100)
    await ARM_MOTOR(ARM_RIGHT,100,-150)
    await LEFT_GYRO(25,200)
    await RIGHT_GYRO(25,200)
    await GYRO_INCH_BK(7.2,-100)
    await RIGHT_GYRO(75,500)
    await GYRO_INCH(31,500)
